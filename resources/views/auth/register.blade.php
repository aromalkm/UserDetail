    ...
    <div class="card">
        <div class="card-body register-card-body">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="input-group mb-3">
                    <input id="dob" type="date" class="form-control @error('dob') is-invalid @enderror" maxlength="10" name="dob" value="{{ old('dob') }}" required autocomplete="dob" autofocus placeholder="Date Of Birth">
                    <div class="input-group-append">
                        <div class="input-group-text">
